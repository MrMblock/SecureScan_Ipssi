 ...
 * Redirige vers le provider OAuth ; le callback revient sur /login?code=...&state=<provider>
 */
const SocialSignIn = () => {
  return (
    <div className='flex gap-3 justify-center'>
      <button
        ...
        className='flex items-center justify-center gap-2 rounded-full border border-white/20 bg-white/5 px-8 py-3 text-white duration-200 hover:bg-white/10 cursor-pointer'>
